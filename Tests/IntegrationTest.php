...
class IntegrationTest extends TestCase
{
    ...
    const TURNSTILE_TESTING_SITE_KEY = '1x00000000000000000000AA';
    const TURNSTILE_TESTING_SECRET_KEY = '1x0000000000000000000000000000000AA';

    /**
     * @var TurnstileIntegration
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->integration = $this->getMockBuilder(TurnstileIntegration::class)
            ->disableOriginalConstructor()
            ->getMock();

        $this->integration
            ->method('getKeys')
            ->willReturn(['site_key' => self::TURNSTILE_TESTING_SITE_KEY, 'secret_key' => self::TURNSTILE_TESTING_SECRET_KEY]);
    ...
    public function testOnFormValidate()
    {
        ...
        $formSubscriber = new FormSubscriber(
            $this->eventDispatcher,
            $this->integrationHelper,
            new TurnstileClient($this->integrationHelper),
            $leadModel,
            $translator
        );

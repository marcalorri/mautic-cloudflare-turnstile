...
namespace MauticPlugin\MauticTurnstileBundle\EventListener;
...
use MauticPlugin\MauticTurnstileBundle\Form\Type\TurnstileType;
use MauticPlugin\MauticTurnstileBundle\Integration\TurnstileIntegration;
use MauticPlugin\MauticTurnstileBundle\TurnstileEvents;
...
class FormSubscriber implements EventSubscriberInterface
{
     ...
     * @var boolean
     */
    private $turnstileIsConfigured = false;
    ...
    public function __construct(
        ...
        if ($integrationObject instanceof AbstractIntegration) {
            ...
            $this->mode      = isset($keys['mode']) ? $keys['mode'] : null;
    ...
    public static function getSubscribedEvents()
    {
        return [
            ...
            TurnstileEvents::ON_FORM_VALIDATE => ['onFormValidate', 0],
        ];
    }
    ...
    public function onFormBuild(FormBuilderEvent $event)
    {
        ...
        $event->addFormField('plugin.turnstile', [
            'label'          => 'mautic.plugin.actions.turnstile',
            'formType'       => TurnstileType::class,
            'template'       => 'MauticTurnstileBundle:Integration:turnstile.html.php',
            'builderOptions' => [
        ...
        $event->addValidator('plugin.turnstile.validator', [
            'eventName' => TurnstileEvents::ON_FORM_VALIDATE,
    ...
    public function onFormValidate(ValidationEvent $event)
    {
        ...
        if ($this->turnstileClient->verify($event->getValue(), $event->getField())) {
            return;
        }

        $event->failedValidation($this->translator === null ? 'Turnstile was not successful.' : $this->translator->trans('mautic.integration.turnstile.failure_message'));
